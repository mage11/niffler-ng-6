...
public class UsersQueueExtension implements
  ...
  public Queue<StaticUser> getQueueByUserType(UserType.Type type){
      ...
      switch (type){
          case EMPTY : return EMPTY_QUEUE;
          case WITH_FRIENDS : return WITH_FRIENDS_QUEUE;
          case WITH_INCOME_REQUEST: return WITH_INCOME_REQUEST_QUEUE;
          case WITH_OUTCOME_REQUEST : return WITH_OUTCOME_REQUEST_QUEUE;
          default: return EMPTY_QUEUE;
      }
