...
public class StatComponent extends BaseComponent<StatComponent> {
    ...
    @Step("Check that stat colors contains colors {expectedColors}")
    @Nonnull
    public StatComponent checkColors(Color... expectedColors) {
    ...
    @Step("Check that stat bubbles contains colors in any order {expectedColors}")
    @Nonnull
